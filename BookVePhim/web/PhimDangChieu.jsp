    ...
    <body>
        ...
        <style>
            * {
            ...
            ul.container__product-list .product-top a.booking {
                font-weight: 600;
                text-transform: uppercase;
                text-decoration: none;
                text-align: center;
                    ...
                    <li>
                        <div class="product-item">
                            <div class="product-top">
                                ...
                                <a href ="movieShowingDescribe?id=${item.getMovieId()}" class="button_slide detail">Chi tiết </a> <!-- buy-now -->

                                <c:if test="${sessionScope.acc != null}">
                                    <a href ="buyTicket?id=${item.getMovieId()}" class="button_slide booking">Mua vé </a>
                                </c:if>

                                <c:if test="${sessionScope.acc == null}">
                                    <a href ="homeLogin" class="button_slide booking">Mua vé </a>
                                </c:if>
